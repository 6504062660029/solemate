...
const fallbackProducts = [
  ...
  },
  {
    ...
    rating: 4.9,
    review_count: 86,
    image_url: "image/pid2.png?height=300&width=300",
    is_new: true,
  ...
  },
  {
    ...
    rating: 4.7,
    review_count: 52,
    image_url: "image/pid3.png?height=300&width=300",
    is_new: false,
    is_best_seller: true,
    is_on_sale: true,
    category_id: 3,
  ...
  },
  {
    ...
    rating: 4.6,
    review_count: 215,
    image_url: "image/pid4.png?height=300&width=300",
    is_new: false,
    is_best_seller: true,
    is_on_sale: false,
    category_id: 2,
  ...
  },
  {
    ...
    rating: 4.8,
    review_count: 67,
    image_url: "image/pid5.png?height=300&width=300",
    is_new: true,
    is_best_seller: false,
    is_on_sale: true,
    category_id: 4,
  ...
  },
  {
    ...
    rating: 4.7,
    review_count: 183,
    image_url: "image/pid6.png?height=300&width=300",
    is_new: false,
    is_best_seller: true,
    is_on_sale: false,
    category_id: 2,
  ...
  },
  {
    ...
    rating: 4.8,
    review_count: 94,
    image_url: "image/pid7.png?height=300&width=300",
    is_new: true,
    is_best_seller: false,
    is_on_sale: false,
    category_id: 1,
  ...
  },
  {
    ...
    rating: 4.6,
    review_count: 78,
    image_url: "image/pid8.png?height=300&width=300",
    is_new: false,
    is_best_seller: false,
    is_on_sale: false,
    category_id: 1,
...
export async function getProductById(id: number) {
  ...
  if (matchingProduct) {
    ...
    return {
      ...
      images: [matchingProduct.image_url || "/placeholder.svg?height=600&width=600"],
